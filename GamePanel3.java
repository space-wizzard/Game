...
public class GamePanel3 extends JFrame implements GameObject {
    ...
    public GamePanel3() {
        ...
        puzzlePanel.setPreferredSize(new Dimension(600, 600));
    ...
    class MyKeyListener extends KeyAdapter {
    	...
    	if(count>9)
    		return;
        ImageIcon image=new ImageIcon("images/3by3/piece" + count + ".gif");
